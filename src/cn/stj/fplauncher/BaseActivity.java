...
public abstract class BaseActivity extends Activity implements View.OnClickListener {
    ...
    protected void setLeftBtnVisible(int visibility) {
        mLeftBtn.setVisibility(visibility);
    }

    protected void setMidBtnVisible(int visibility) {
        mMidBtn.setVisibility(visibility);
    }

    protected void setRightBtnVisible(int visibility) {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_DPAD_LEFT:
                mBottomKeyClickListener.onDirectLeftKeyPress();
                break;
            case KeyEvent.KEYCODE_DPAD_UP:
                mBottomKeyClickListener.onDirectUpKeyPress();
                break;
            case KeyEvent.KEYCODE_DPAD_RIGHT:
                mBottomKeyClickListener.onDirectRightKeyPress();
                break;
            case KeyEvent.KEYCODE_DPAD_DOWN:
                mBottomKeyClickListener.onDirectDownKeyPress();
                break;
            default:
                break;
        }
